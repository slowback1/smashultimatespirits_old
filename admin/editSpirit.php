...
<form id="edit_spirit" action="../actions/edit_spirit.php" method="post" accept-charset="UTF-8">
    <input type="hidden" name="username" id="username" value="<?php echo $_COOKIE['admin_access'];?>" />
    <label for="spirit">Existing Spirit:</label><select name="id" id="id">
    ...
    ?>
            ...
            <label for="author">Author:</label><input type="text" placeholder="Author" name="author" id="author" class="author"> </input>
