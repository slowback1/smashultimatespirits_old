...
<div id="sideNav" class="sideNav">
  ...
  <a href="actions/randomSpirit.php">Random Spirit</a>
            <?php 
  ...
  echo "<a href='admin/changePassword.php'>Change Password</a>";
    ...
    $left = $max - $total - 1;
    if ($left == 0) {
        echo "<p class='stats'>Good Job!  All $total spirits added!</p>";
    } else {
    ...
    echo "</div></div>";
        ...
        echo "<p class='stats'>All 1303 spirits are accounted for!</p>";
    };
?>
