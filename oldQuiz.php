...
include_once './connection/connect.php';
  ...
  if($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
          ...
          $i += 1;
          $id = $row['id'];
          $answers = $answers . "<input type='radio' name='answer' id='answer' value='$id'>".$row['name']."<img src='img/spiritImages/".$id.".png' alt='image' /></input>";
      }
  }
...
<div class="wrapper">
    <div class="main">
        ...
        <form action="actions/oldHR.php" method="POST">
